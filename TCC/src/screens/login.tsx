    ...
    <div className='flex flex-col relative w-screen h-screen bg-gray-800'>
      ...
      <div className='flex justify-center items-center h-full'>
        <div className='bg-[#7b5cc9] p-8 max-w-md w-full mx-auto rounded-2xl'>
          ...
          {/* <button
            type="submit"
            className="group relative flex w-full justify-center rounded-md  bg-violet-300 mt-2 py-2 px-4 font-medium text-violet-900 hover:bg-violet-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            <span>Registrar</span>
          </button> */}
        </div>
